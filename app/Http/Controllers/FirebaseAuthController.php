...
class FirebaseAuthController extends Controller
{
    ...
    public function test_firebase(){
        ...
        // dd('sent', $resp, $fcm_tokens,$notification,$data);
    }
...
public function sendNotification(Request $request)
    {
        ...
        $SERVER_API_KEY = 'BOuXdkLNpvSzRoWxcqyEVLA7EDbei4VoselKiIjJXMqWXbizmfd_wUPT78W2tBllSpYOItNWzrJ8J1uw2Ts2T7A';
$title = "title";
$body = "message";
        $data = [
...
// dd($data,$notification,$fcm_tokens,$message,$sendReport);
    }
