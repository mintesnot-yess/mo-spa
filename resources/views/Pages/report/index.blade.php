                                ...
                                <form method="GET" action="{{ route('report.show') }}"
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="client"  class="form-control select">
                                                <option value="all">All</option>
                                        ...
                                        <div class="col-md-3">
                                            <label for="end" class="font-weight-bold">Status</label>
                                            <select name="client"  class="form-control select">
                                                <option value="all">All</option>
                                                <option value="1">Pending</option>
                                                <option value="0">Complated</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="end" class="font-weight-bold">Customer Type</label>
